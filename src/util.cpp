...
const char * const BITCOIN_CONF_FILENAME = "schoin.conf";
const char * const BITCOIN_PID_FILENAME = "schoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Schoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Schoin";
#else
    // Unix
    return pathRet / ".schoin";
#endif
#endif
}
