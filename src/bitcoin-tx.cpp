...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s schoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  schoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded schoin transaction") + "\n" +
              "  schoin-tx [options] -create [commands]   " + _("Create hex-encoded schoin transaction") + "\n" +
              "\n";
