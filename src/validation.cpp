...
#if defined(NDEBUG)
# error "Schoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Schoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SCH additional fees, %d delta bytes\n",
